...
import { quoterABI } from './abi/quoter-abi';
import { quoterV2ABI } from './abi/quoter-v2-abi';
...
export abstract class SwapQuoter {
    ...
    public static quoteCallParameters<TInput extends Currency, TOutput extends Currency>(
        ...
        if (singleHop) {
            ...
            const v1QuoteParams = [baseQuoteParams.tokenIn, baseQuoteParams.tokenOut, baseQuoteParams.fee, quoteAmount, baseQuoteParams.sqrtPriceLimitX96] as const;
