import { Percent, Token, CurrencyAmount, WETH9, Ether } from '@real-wagmi/sdk';
...
describe('NonfungiblePositionManager', () => {
    ...
    describe('#addCallParameters', () => {
        ...
        it('throws if pool does not involve ether and useNative is true', () => {
            expect(() =>
                NonfungiblePositionManager.addCallParameters(
                    ...
                    { recipient, slippageTolerance, deadline, useNative: Ether.onChain(250) },
                ),
            ).toThrow('NO_WETH');
        });
        ...
        it('useNative', () => {
            ...
            expect(calldata).toEqual(
                '',
            );
    ...
    describe('#collectCallParameters', () => {
        ...
        it('works with eth', () => {
            const { calldata, value } = NonfungiblePositionManager.collectCallParameters({
                ...
                expectedCurrencyOwed1: CurrencyAmount.fromRawAmount(Ether.onChain(250), 0),
                recipient,
            });
    ...
    describe('#removeCallParameters', () => {
        ...
        it('works with eth', () => {
            const ethAmount = CurrencyAmount.fromRawAmount(Ether.onChain(250), 0);
