...
function getToken0Amount(tickCurrent: number, tickLower: number, tickUpper: number, sqrtRatioX96: bigint, liquidity: bigint): bigint {
...
function getToken1Amount(tickCurrent: number, tickLower: number, tickUpper: number, sqrtRatioX96: bigint, liquidity: bigint): bigint {
    if (tickCurrent < tickLower) {
        return ZERO;
    }
    if (tickCurrent < tickUpper) {
