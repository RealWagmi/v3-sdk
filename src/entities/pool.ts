import { BigintIsh, CurrencyAmount, Price, Token } from '@real-wagmi/sdk'
import invariant from 'tiny-invariant'
import { Address } from 'viem'
import { FeeAmount, TICK_SPACINGS } from '../constants'
import { NEGATIVE_ONE, ONE, Q192, ZERO } from '../constants/misc'
import { computePoolAddress } from '../utils/compute-pool-address'
import { LiquidityMath } from '../utils/liquidity-math'
import { SwapMath } from '../utils/swap-math'
...
export class Pool {
  ...
  private overratedTickSpacing?: number;
  ...
  public constructor(
    ...
    this.overratedTickSpacing = tickSpacing;
  }
