...
describe('Route', () => {
    ...
    const token0 = new Token(250, '0x0000000000000000000000000000000000000001', 18, 't0');
    const token1 = new Token(250, '0x0000000000000000000000000000000000000002', 18, 't1');
    const token2 = new Token(250, '0x0000000000000000000000000000000000000003', 18, 't2');
    ...
    describe('path', () => {
        it('constructs a path from the tokens', () => {
            ...
            expect(route.chainId).toEqual(250);
        });
